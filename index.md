...
<section class="hero">
  ...
  <aside class="hero-note">
    <p>This site gathers talks, writings, research and selected projects.</p>
    <p>It is an archive rather than a stream: work is arranged so that it can be found, returned to and read in relation.</p>
  </aside>
</section>
...
<section>
  ...
  <div class="cards">
    <article class="card"><span class="number">01</span><h3>Writings</h3><p>Essays, chapters, working papers and shorter reflections.</p><a href="{{ '/writings/' | relative_url }}">Browse writings</a></article>
    <article class="card"><span class="number">02</span><h3>Projects</h3><p>Longer bodies of research, artistic work and developing practices.</p><a href="{{ '/projects/' | relative_url }}">View projects</a></article>
